...
\newcounter{goal}
\newenvironment{goal}[1][]{\refstepcounter{goal}\par\medskip
   G[\thegoal] - #1 \rmfamily}{\medskip}

\newcounter{assumption}
\newenvironment{assumption}[1][]{\refstepcounter{assumption}\par\medskip
   D[\theassumption] - #1 \rmfamily}{\medskip}

\newcounter{funcreq}
\newenvironment{funcreq}[1][]{\refstepcounter{funcreq}\par\medskip
   FR[\thefuncreq] - #1 \rmfamily}{\medskip}

\newcounter{secreq}
\newenvironment{secreq}[1][]{\refstepcounter{secreq}\par\medskip
   SR[\thesecreq] - #1 \rmfamily}{\medskip}
